...
public class EsSearchServiceImpl implements EsQueryService {
    ...
    @Override
    public <T>List<Map<String, Object>> associate(Integer size, T obj ,String inputStr) throws IOException {
        //请求
    ...
    private void isSearchAfter(PageSortHighLight pageSortHighLight,
                               SearchSourceBuilder searchSourceBuilder,
                               Attach attach , Map<String,Boolean> flagMap) {
        searchAfter(attach, pageSortHighLight, searchSourceBuilder);
    ...
    public PageList<JSONObject> search(QueryBuilder queryBuilder,String collapseField ,
        ...
        if (attach == null) {
            ...
            searchRequest.source(searchSourceBuilder);
            if (StringUtils.isNotEmpty(attach.getRouting())) {
                searchRequest.routing(attach.getRouting());
            }
            ...
            for (SearchHit hit : searchHits) {
                ...
                if (highLightFlag) {
                    ...
                    HighlightMap.forEach((k, v) -> {
                        try {
                            Object obj = mapToObject(HighlightMap, JSONObject.class);
                            BeanUtils.copyProperties(obj, t, BeanTools.getNoValuePropertyNames(obj));
                ...
                if(innerHits != null){
                    ...
                    innerHits.keySet().forEach(key->{
                        ...
                        t.put("innerHitsTotal",innerSearchHits.getTotalHits().value);
                    });
                    t.put("innerHits",jsonObjectList);
                }
    ...
    private void searchAfter(Attach attach, PageSortHighLight pageSortHighLight, SearchSourceBuilder searchSourceBuilder) {
        if (pageSortHighLight != null && pageSortHighLight.getPageSize() != 0) {
            searchSourceBuilder.size(pageSortHighLight.getPageSize());
        } else {
